...
const Navbar: React.FC = () => {
    ...
    const userButton = <ButtonUser />;

    return (
        <nav className="flex items-center">
            <div
                className="menu w-6 sm:hidden cursor-pointer"
                onClick={isShow}
            ></div>
            <div
                className="search bg-center cursor-pointer border rounded-md border-[#FFFFFF1A] ml-5 sm:hidden" /*onClick={isSearch}*/
            ></div>
        ...
        transition-all duration-300 ease-in-out`}
            >
                ...
                <li>
                    <Link to="/" className="text-white block py-4">
                        About
                    </Link>
                </li>
                <li>
                    <Link to="/setting" className="text-white block py-4">
                        Settings
                    </Link>
                </li>
                <li>
